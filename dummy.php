...
<body class="bg-gray-900 text-white font-sans overflow-y-auto">

  <div class="flex min-h-screen">
    <!-- Sidebar -->
    <aside class="h-screen fixed w-64 bg-gray-800 flex flex-col justify-between p-6">
      <a href="index.php" class="p-4 text-xl font-bold text-blue-400">ILABS</a>
      ...
      <a href="<?= BASEURL ?>Login/index" class="mt-6 block w-full text-center bg-blue-700 py-2 rounded-md">Login</a>
    </aside>
