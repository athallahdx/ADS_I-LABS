...
<div class="flex h-auto">
    ...
    <header class="flex items-center justify-between">
        <h1 class="text-2xl font-bold">Course yang Tersedia</h1>
    ...
    <section class="mt-6 grid grid-cols-1 md:grid-cols-2  gap-6">
        ...
        <img src="../public/img/sistem operasi.webp" alt="" class="w-[600px] h-[300px] mt-5">
        ...
        <p class="text-gray-400">Semester 2 </p>
        <img src="../public/img/strukdat.jpg" alt="" class="w-[600px] h-[300px] mt-5">
        <div class="flex items-center justify-between mt-4">
            <div>
            <button class="mt-2 px-4 py-2 bg-teal-500 text-white rounded-lg">Details</button>
            </div>
